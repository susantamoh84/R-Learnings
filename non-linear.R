...
#When using gam() to model outcome as an additive function of the inputs, you can use the s() function 
#inside formulas to designate that you want use a spline to model the non-linear relationship 
#of a continuous variable to the outcome.
